const TSearchInput = {
  baseClass: 'shadow-border block rounded focus:outline-none focus:shadow-focus bg-purple-4 hover:shadow-borderDark transition-shadow duration-150 in-out',
